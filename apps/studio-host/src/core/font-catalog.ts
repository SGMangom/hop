...
export const FONT_LIST: readonly FontEntry[] = [
  { name: 'Computer Modern', file: './fonts/ComputerModern-Regular.ttf', format: 'truetype' },
  { name: 'Computer Modern', file: './fonts/ComputerModern-Italic.ttf', format: 'truetype', style: 'italic' },
  { name: 'Computer Modern', file: './fonts/ComputerModern-Bold.ttf', format: 'truetype', weight: '700' },
